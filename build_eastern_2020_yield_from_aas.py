#!/usr/bin/env python3
"""
Build a district-year maize yield table for Eastern Uganda from the extracted
AAS 2020 maize sub-region table.

This does not invent new values. It assigns each district the maize statistics
reported for its UBOS AAS 2020 sub-region and marks the source granularity
explicitly.
...
Outputs:
  - aas2020_eastern_district_yield.csv
  - aas2020_eastern_district_yield_total_2020.csv
"""
...
INPUT_FILE = Path("aas2020_maize_subregion.csv")
OUTPUT_FILE = Path("aas2020_eastern_district_yield.csv")
TOTAL_OUTPUT_FILE = Path("aas2020_eastern_district_yield_total_2020.csv")
...
def main():
    print("=" * 70)
    print("  BUILD EASTERN UGANDA 2020 YIELD TABLE FROM AAS 2020")
    print("=" * 70)
