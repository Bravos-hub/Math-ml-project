#!/usr/bin/env python3
"""
Build a district-year beans yield table for Eastern Uganda from the extracted
AAS 2020 beans sub-region table.

This assigns each district the beans statistics reported for its UBOS AAS 2020
sub-region and preserves source granularity metadata.

Input:
  - aas2020_beans_subregion.csv

Outputs:
  - aas2020_eastern_district_beans_yield.csv
  - aas2020_eastern_district_beans_yield_total_2020.csv
"""
...
INPUT_FILE = Path("aas2020_beans_subregion.csv")
OUTPUT_FILE = Path("aas2020_eastern_district_beans_yield.csv")
TOTAL_OUTPUT_FILE = Path("aas2020_eastern_district_beans_yield_total_2020.csv")
...
def main():
    print("=" * 70)
    print("  BUILD EASTERN UGANDA 2020 BEANS YIELD TABLE FROM AAS 2020")
    print("=" * 70)
